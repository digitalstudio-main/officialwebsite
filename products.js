      ...
      card.innerHTML = `
        ...
        <div class="product-body">
          ...
          <div class="product-actions">
            <button class="btn-sm btn-know js-know">Know more</button>
    ...
    if(pmOverlay){
      ...
      pmOverlay.querySelector(".pm-save").addEventListener("click", ()=>{
        ...
        if(editingId){
          ...
          if(idx>-1) products[idx] = {...products[idx], name, price, desc, image};
        } else {
          products.push({id:uid(), name, price, desc, image});
        }
        saveProducts(products);
